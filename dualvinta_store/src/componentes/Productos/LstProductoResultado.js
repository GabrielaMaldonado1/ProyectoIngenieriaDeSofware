...
export const LstProductoResultado = ({ titulo, filtro }) => {
                ...
                <div className="row" style={{}}>
                    {
                        data.map((producto, index) => {
                            ...
                            if ( (producto.categoria === filtro) || (producto.name === filtro) || (producto.filtro === filtro) ) {
...
export default LstProductoResultado;
